...
![ipaddresstypes](https://media.discordapp.net/attachments/1174180230039081021/1178925265586507797/image.png?ex=6577eab6&is=656575b6&hm=d2f4c0727cdb42d2866af4547bb7aae5a5a176f27af763db9d999073a5a6ca94&=&format=webp&width=1485&height=640)
...
5. Bob wants to use the domain bob.is.the.best.com. What domain should he buy from a DNS provider (assume it is available)? What would be the subdomains?
...
1. How does TCP prevent packets from arriving out of order? (Hint: specially "out of order")
(A) Resends lost packets
(B) Assigns each segment a number
(C) Reassembles out of order packets
(D) Sends all packets to one destination address
